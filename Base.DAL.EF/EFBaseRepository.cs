...
public class
    EFBaseRepository<TDomainEntity, TDalEntity, TDbContext> :
    EFBaseRepository<Guid, TDomainEntity, TDalEntity, TDbContext>, IBaseRepository<TDalEntity>
    where TDomainEntity : class, IEntityId
    where TDalEntity : class, IEntityId
    where TDbContext : DbContext
{
    public EFBaseRepository(TDbContext dataContext, IMapper<TDomainEntity, TDalEntity> mapper) : base(dataContext,
        mapper)
    {
    }
}

public class EFBaseRepository<TKey, TDomainEntity, TDalEntity, TDbContext> : IBaseRepository<TDalEntity, TKey>
